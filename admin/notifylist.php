        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <form method="post" action="index.php" id="msgtplform">
                    ...
                    <div class="card-body">
                        <p class="text-muted"><?php echo isset($msgtplrow['ntdesc']) ? $msgtplrow['ntdesc'] : '<i class="fa fa-fw fa-long-arrow-alt-up"></i> Please select the notification template from the drop down list.'; ?></p>
                        ...
                        if ($msgtplrow['ntid'] > 0) {
                            ...
                            <div class="form-group">
                                <label for="selectgroup-pills"<?php echo myvalidate($disoptfor_reg); ?>>Copy Email to Admin</label>
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio" name="cctoadmin" value="1" class="selectgroup-input"<?php echo myvalidate($cctoadmin_cek[1]); ?><?php echo myvalidate($disoptfor_reg); ?>>
