        ...
        <form method="post" action="dohistory.php">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-8">
                    ...
                    <div class="text-small text-muted"><i class="fas fa-exclamation-triangle text-danger"></i> This option will not process any other tasks (generate or update commissions, change member or order status, etc.).</div>
                </div>
            </div>
