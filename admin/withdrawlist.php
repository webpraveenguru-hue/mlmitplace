                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div>
                            ...
                            <a href="javascript:;" data-href="dowithdraw.php?doact=excsv&sqlflter=<?php echo myvalidate($condition64); ?>&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" class="btn btn-success bootboxconfirm" data-poptitle="Export Data" data-popmsg="<div class=text-info>Are you sure you want to export the current withdrawal request?</div>"><i class="fas fa-fw fa-file-csv"></i> Export Withdrawal Request</a>
                        </div>
                    </div>
                </div>
            </div>
