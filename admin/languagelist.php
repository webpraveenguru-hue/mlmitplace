...
INI_HTML;
    ...
    foreach ($langval as $key => $value) {
        ...
        $wordstr = str_replace('"', "'", $value);
        $langfcnt .= "\$LANG['{$key}'] = \"" . $wordstr . "\";" . chr(13);
    }
        ...
        <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <select name="langid" class="form-control select1">
                                ...
                                <?php
                                $TEMPLANG = $LANG;
                                $langfiles = (file_exists($langdir)) ? scandir($langdir) : [];
                                $langhit = 0;
            ...
            <div class="card">
                <form method="post" action="index.php" id="msgtplform" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="card-body">
                        <p class="text-muted"><?php echo ($langid != '') ? '' : '<i class="fa fa-fw fa-long-arrow-alt-up"></i> Please select the Language from the drop down list or click the <strong>Create New</strong> button to add a language based on English!'; ?></p>
                            ...
                            <div class="row">
                                ...
                                foreach ($LANG as $key => $value) {
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        if (strlen($value) < 46) {
                                            ?>
                                            <input class="form-control" type="text" name="langval[<?php echo myvalidate($key); ?>]" id="<?php echo myvalidate($key); ?>" value="<?php echo myvalidate($value); ?>" placeholder="<?php echo myvalidate($TEMPLANG[$key]); ?>">
                                            <?php
                                        } else {
                                            ?>
                                            <textarea class="form-control" name="langval[<?php echo myvalidate($key); ?>]" id="<?php echo myvalidate($key); ?>" placeholder="<?php echo myvalidate($TEMPLANG[$key]); ?>"><?php echo myvalidate($value); ?></textarea>
                                            <?php
                                        }
                                        ?>
                                    </div>
