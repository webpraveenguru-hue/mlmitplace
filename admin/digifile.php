...
if (isset($FORM['fltoken']) and $FORM['fltoken'] != "") {
    $condition .= ' AND (flpath LIKE "%' . $FORM['fltoken'] . '%" OR fltoken LIKE "%' . $FORM['fltoken'] . '%") ';
}
...
$digfData = $db->getRecFrmQry("SELECT * FROM " . DB_TBLPREFIX . "_files WHERE 1 " . $condition . $sqlshort . $pages->limit . "");
?>
